...
public class AvaritiaItems {
    ...
    public static final Item CRYSTAL_MATRIX_INGOT = register("crystal_matrix_ingot", new ItemWithTooltip(new FabricItemSettings()));
    public static final Item NEUTRON_PILE = register("neutron_pile", new ItemWithTooltip(new FabricItemSettings()));
    public static final Item NEUTRON_NUGGET = register("neutron_nugget", new ItemWithTooltip(new FabricItemSettings()));
    public static final Item NEUTRONIUM_INGOT = register("neutronium_ingot", new ItemWithTooltip(new FabricItemSettings()));
    public static final Item ENDEST_PEARL = register("endest_pearl", new Item(new FabricItemSettings()));
    public static final Item SKULLFIRE_SWORD = register("skullfire_sword", new SwordWithTooltip(ToolMaterials.DIAMOND,3, -2.0F, new FabricItemSettings().rarity(Rarity.RARE)));
    public static final Item SINGULARITY = register("singularity", new SingularityItem());
    public static final Item RECORD_FRAGMENT = register("record_fragment", new ItemWithTooltip(new FabricItemSettings().fireproof()));
    ...
    public static final Item INFINITY_CATALYST = register("infinity_catalyst", new ItemWithTooltip(new FabricItemSettings().fireproof().rarity(Rarity.RARE)));
    public static final Item INFINITY_INGOT = register("infinity_ingot", new ItemWithTooltip(new FabricItemSettings().fireproof().rarity(Rarity.RARE)));
